...
### Key References
- **Spec**: `agileplus-specs/001-spec-driven-development-engine/spec.md` -- observability requirements
- **Plan**: `agileplus-specs/001-spec-driven-development-engine/plan.md` -- telemetry crate in dependency graph, performance goals (<50ms CLI startup)
- **Data Model**: `agileplus-specs/001-spec-driven-development-engine/data-model.md` -- Metric entity (command, duration_ms, agent_runs, review_cycles)
