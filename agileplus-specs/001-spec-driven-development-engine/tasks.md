...
**Inputs**: Design documents from `agileplus-specs/001-spec-driven-development-engine/`
...
- Spec written to git (agileplus-specs/<feature>/spec.md) AND indexed in SQLite
...
- [x] T127 Seed sub-command prompt files from hybridized reference commands (agileplus, bmad, gsd, openspec superset)
