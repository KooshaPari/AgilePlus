...
<!-- Summarize the change in 1-3 sentences. AgilePlus spec-kitty and FR traceability apply to substantive work; trivial fixes skip the spec. -->
...
<!-- List local validation performed. Do not rely on billed CI. -->
- [ ] Local lint / format checks pass
- [ ] Local tests pass
