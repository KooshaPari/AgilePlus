...
| P0 | Credentials | File and keychain stores coexist; production safety cannot be inferred from intent. | Keychain-only production factory and secret-redaction verification. |
