...
export AGILEPLUS_GRPC_PORT="$(pick_port AGILEPLUS_GRPC_PORT 5014)"
export AGILEPLUS_API_URL="http://127.0.0.1:${AGILEPLUS_API_PORT}"
export AGILEPLUS_API_HEALTH_URL="${AGILEPLUS_API_URL}/health"
...
AGILEPLUS_GRPC_PORT=${AGILEPLUS_GRPC_PORT}
AGILEPLUS_API_URL=${AGILEPLUS_API_URL}
AGILEPLUS_API_HEALTH_URL=${AGILEPLUS_API_HEALTH_URL}
EOF
