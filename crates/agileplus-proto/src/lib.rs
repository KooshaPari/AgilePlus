...
// Exhaustive contract tests for the protoc-generated types. Only meaningful
// when real prost/tonic codegen ran (the stubs do not implement prost::Message).
#[cfg(all(test, not(agileplus_proto_stubs)))]
mod proto_tests;

// Contract tests for the fallback stubs (protoc unavailable).
#[cfg(all(test, agileplus_proto_stubs))]
mod proto_stub_tests;
