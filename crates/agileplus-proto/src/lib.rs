...
mod tests {
    ...
    fn test_feature_serialize_deserialize() {
        // Test that proto types serialize/deserialize correctly with prost
        let feature = Feature {
            id: 42,
    ...
    fn test_backlog_item_roundtrip() {
        // Additional smoke test: BacklogItemProto serialize/deserialize
    ...
    fn test_command_response_with_hashmap() {
        // Test CommandResponse with HashMap field
