...
scripts:
  sh: "agileplus agent feature merge"
  ps: "agileplus agent"
---
...
4. ✅ Run the command from the feature worktree (AgilePlus will move the merge to the primary repo automatically)
...
AgilePlus uses an **opinionated worktree approach**:
