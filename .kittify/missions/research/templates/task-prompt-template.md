...
- Link to supporting specs: `.kittify/memory/constitution.md`, `agileplus-specs/.../plan.md` (methodology), `agileplus-specs/.../spec.md` (research question), `research.md`, `data-model.md`.
