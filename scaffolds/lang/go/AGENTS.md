...
This project follows the Phenotype governance standards.

### Style Constraints

- **Line length**: 100 characters (Rust) / 88 characters (Python)
- **Formatter**: `cargo fmt` / `ruff format` / `gofmt` / `prettier`
