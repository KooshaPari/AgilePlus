...
superseded_by: |
  Governance docs landed and indexed via:
    - repos/docs/governance/* (scripting_policy, target_budget_policy, org-pages, etc.)
    - Phenotype/CLAUDE.md and repos/CLAUDE.md hierarchy
...
**Slug**: governance-sync | **Date**: 2026-03-29 | **State**: specified
